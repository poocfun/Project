    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    <li><a class="active" href="{{ url('homee') }} ">Home</a></li>
                    <li><a class="active" href="#   ">Cari Loker</a></li>
            ...
            <a class="btn btn  text-white" style="background-color:#0075FF;" href="{{ url('log-in') }}">Login</a>
